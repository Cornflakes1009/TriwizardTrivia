...
let shareButtonSymbol       =   "square.and.arrow.up"
...
var totalNumberOfWords      =   defaults.integer(forKey: "totalNumberOfWords")
var totalCorrectWords       =   defaults.integer(forKey: "totalCorrectWords")
