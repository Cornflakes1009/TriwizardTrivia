...
let titleLabelFont          =   UIFont(name: "ParryHotter", size: 30)
let instructionLabelFont    =   UIFont(name: "Anton", size: 20)
...
let buttonTitleColor        =   UIColor.rgb(red: 255, green: 223, blue: 0, alpha: 1)
let buttonFont              =   UIFont(name: "ParryHotter", size: 30)
