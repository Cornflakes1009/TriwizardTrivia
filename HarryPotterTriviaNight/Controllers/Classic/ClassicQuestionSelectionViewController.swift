//
//  ClassicQuestionSelectionViewController.swift
...
class ClassicQuestionSelectionViewController: UIViewController {
    ...
    let fifteenButton: GameButton = {
        ...
        button.addTarget(nil, action: #selector(fifteenTapped), for: .touchUpInside)
    ...
    let twentyFiveButton: GameButton = {
        ...
        button.addTarget(nil, action: #selector(twentyFiveTapped), for: .touchUpInside)
        button.titleLabel?.font = buttonFont
    ...
    let fiftyButton: GameButton = {
        ...
        button.addTarget(nil, action: #selector(fiftyTapped), for: .touchUpInside)
        button.titleLabel?.font = buttonFont
        return button
    }()
    ...
    let oneHundredButton: GameButton = {
        ...
        button.addTarget(nil, action: #selector(oneHundredTapped), for: .touchUpInside)
        button.titleLabel?.font = buttonFont
        return button
    }()
    ...
    private func startGameNavigation() {
        let vc = ClassicPlayViewController()
